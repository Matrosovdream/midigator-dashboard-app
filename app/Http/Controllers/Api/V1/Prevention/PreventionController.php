...
namespace App\Http\Controllers\Api\V1\Prevention;
...
use App\Http\Actions\Api\V1\Prevention\ResolvePreventionAction;
...
{
    private const TYPE = CaseRegistry::PREVENTION;
    ...
    public function resolve(Request $request, int $id, ResolvePreventionAction $action): JsonResponse
    {
